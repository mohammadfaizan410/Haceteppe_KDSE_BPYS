...
<body style="background-color:white">
    ...
    <div id="tick"></div>
                        ...
                        if (count($ozgecmisform1) > 0 && $ozgecmisform1 !== '') {
                            ...
                            foreach ($ozgecmisform1 as $ozgecmisform1_columns) {
                                ...
                                echo "
                                    ...
                                    href='$base_url/formlar-review/Form1-ozgecmis-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                    >
                                    <p>Özgeçmiş</p>
                                    <p>$date</p>
                                    </a>";
                            ...
                            if (count($solunumgereksinimi_form1) > 0 && $solunumgereksinimi_form1 !== '') {
                                ...
                                foreach ($solunumgereksinimi_form1 as $solunumgereksinimi_form1_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form1-Solunumgereksinimi-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($form1_beslenme) > 0 && $form1_beslenme !== '') {
                                ...
                                foreach ($form1_beslenme as $form1_beslenme_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form1-beslenme-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($bosaltimform1) > 0 && $bosaltimform1 !== '') {
                                ...
                                foreach ($bosaltimform1 as $bosaltimform1_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form1-Bosaltim-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($hareketform1) > 0 && $hareketform1 !== '') {
                                ...
                                foreach ($hareketform1 as $hareketform1_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form1-hereket-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($form1_uyku) > 0 && $form1_uyku !== '') {
                                ...
                                foreach ($form1_uyku as $form1_uyku_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form1-uyku-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($vucudutemizform1) > 0 && $vucudutemizform1 !== '') {
                                ...
                                foreach ($vucudutemizform1 as $vucudutemizform1_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form1-Vucudu-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($katererform1) > 0 && $katererform1 !== '') {
                                ...
                                foreach ($katererform1 as $katererform1_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form1-Katerer-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                                        <p>Kateter / Dren</p>
                                        <p>$date</p>
                                        </a>";
                            ...
                            if (count($ilestimform1) > 0 && $ilestimform1 !== '') {
                                ...
                                foreach ($ilestimform1 as $ilestimform1_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form1-Iletisim-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($calismaform1) > 0 && $calismaform1 !== '') {
                                ...
                                foreach ($calismaform1 as $calismaform1_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form1-Calisma-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($egitimform1) > 0 && $egitimform1 !== '') {
                                ...
                                foreach ($egitimform1 as $egitimform1_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form1-egitim-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($form2) > 0 && $form2 !== '') {
                                ...
                                foreach ($form2 as $form2_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form2-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($form3) > 0 && $form3 !== '') {
                                ...
                                foreach ($form3 as $form3_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form3-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($form4) > 0 && $form4 !== '') {
                                ...
                                foreach ($form4 as $form4_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form4-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                                        <p>Düşme Bildirimi</p>
                                        <p>$date</p>
                                        </a>";
                            ...
                            if (count($form5) > 0 && $form5 !== '') {
                                ...
                                foreach ($form5 as $form5_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form5-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($form6) > 0 && $form6 !== '') {
                                ...
                                foreach ($form6 as $form6_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form6-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($form7) > 0 && $form7 !== '') {
                                ...
                                foreach ($form7 as $form7_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form7-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($form8) > 0 && $form8 !== '') {
                                ...
                                foreach ($form8 as $form8_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form8-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($form9) > 0 && $form9 !== '') {
                                ...
                                foreach ($form9 as $form9_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form9-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($form10) > 0 && $form10 !== '') {
                                ...
                                foreach ($form10 as $form10_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form10-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($form11) > 0 && $form11 !== '') {
                                ...
                                foreach ($form11 as $form11_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form11-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                            ...
                            if (count($form12) > 0 && $form12 !== '') {
                                ...
                                foreach ($form12 as $form12_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form12-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                                        <p>Sıvı İzlem</p>
                                        <p>$date</p>
                                        </a>";
                            ...
                            if (count($form13) > 0 && $form13 !== '') {
                                ...
                                foreach ($form13 as $form13_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form13-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                                        <p>Medikal Tedavi</p>
                                        <p>$date</p>
                                        </a>";
                            ...
                            if (count($form14) > 0 && $form14 !== '') {
                                ...
                                foreach ($form14 as $form14_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form14-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
                                        <p>Bakım Planı</p>
                                        <p>$date</p>
                                        </a>"; 
                            ...
                            if (count($form15) > 0 && $form15 !== '') {
                                ...
                                foreach ($form15 as $form15_columns) {
                                    ...
                                    echo "
                                        ...
                                        href='$base_url/formlar-review/Form15-review.php?form_id=$form_id&patient_id=$patient_id&patient_name=$patient_name&student_id=$student_id&student_name=$student_name'
                                        >
        ...
        <script>
            ...
            var student_name = <?php echo json_encode($_GET['student_name']); ?>;
$(function() {
