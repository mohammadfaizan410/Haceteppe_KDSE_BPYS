    ...
    <span class='close closeBtn p-3' id='closeBtn1'>&times;</span>
        ...
        <div class="send-patient p-5">
            <div class="d-flex align-items-center justify-content-between mb-4">
                    <p style="color : #333333; font-size: 20px" class="pb-2">Formlar</p>
                            ...
                            foreach ($allForms as $key => $currentTableAllForms) {
                                foreach ($currentTableAllForms as $currentKey => $form) {
                                    ...
                                    if ($key === 'table1_data') {
                                        ...
                                        <a class="nav-items review btn btn-success p-3" style="color: white;" href="' . $base_url . '/formlar-review/Form2-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_name . '&patient_name=' . $patient_id . '&student_id=' . $student_id . '&student_name='.$student_name.'">                                        <p class="entered-forms-p">Form2 Date: ' . $update_date . '</p>
                                        </a>
                                    ...
                                    if ($key ===  'table2_data') {
                                        ...
                                        <div class="entered-forms align-items-center">
                                        <a class="nav-items review btn btn-success p-3" style="color: white;" href="' . $base_url . '/formlar-review/Form3-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'">
                                    ...
                                    if ($key ===  'table5_data') {
                                        ...
                                        $update_date = $form["creation_date"];
                                        $form_6_options .= '<li class="m-2 p-2"><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3" style="color: white;" href="' . $base_url . '/formlar-review/Form6-review.php?display=0&form_id=' . $form_id . ' &patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form6 Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table6_data') {
                                        $form_id = $form["form_id"];
                                    ...
                                    if ($key ===  'table7_data') {
                                        ...
                                        $update_date = $form["creation_date"];
                                        $form_8_options .= '<li class="m-2 p-2"><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"  style="color: white;" href="' . $base_url . '/formlar-review/Form8-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form8 Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table8_data') {
                                        $form_id = $form["form_id"];
                                        $root9_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_9_options .= '<li class="m-2 p-2"><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"  style="color: white;" href="' . $base_url . '/formlar-review/Form9-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form9 Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table9_data') {
                                        $form_id = $form["form_id"];
                                        $root10_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_10_options .= '<li class="m-2 p-2"><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"  style="color: white;" href="' . $base_url . '/formlar-review/Form10-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form10 Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table10_data') {
                                        $form_id = $form["form_id"];
                                        $root11_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_11_options .= '<li class="m-2 p-2"><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"  style="color: white;" href="' . $base_url . '/formlar-review/Form11-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form11 Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table11_data') {
                                        $form_id = $form["form_id"];
                                        $root12_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_12_options .= '<li class="m-2 p-2"><div class="entered-formsalign-items-center"><a class="nav-items review btn btn-success p-3"   style="color: white;" href="' . $base_url . '/formlar-review/Form12-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form12 Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table12_data') {
                                        $form_id = $form["form_id"];
                                        $root13_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_13_options .= '<li class="m-2 p-2"><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"   style="color: white;" href="' . $base_url . '/formlar-review/Form13-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form13 Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table13_data') {
                                        $form_id = $form["form_id"];
                                        $root14_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_14_options .= '<li class="m-2 p-2"><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"   style="color: white;" href="' . $base_url . '/formlar-review/Form14-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form14 Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table14_data') {
                                        $form_id = $form["form_id"];
                                        $root15_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_15_options .= '<li class="m-2 p-2 "><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"   style="color: white;" href="' . $base_url . '/formlar-review/Form15-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form15 Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table15_data') {
                                        $form_id = $form["form_id"];
                                        $root16_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_16_options .= '<li class="m-2 p-2 "><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"   style="color: white;" href="' . $base_url . '/formlar-review/Form1-ozgecmis-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form1 Ozgecmis Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table16_data') {
                                        $form_id = $form["form_id"];
                                        $root17_id = $form["form_id"];
                                        $update_date = $form["updateDate"];
                                        $form_17_options .= '<li class="m-2 p-2 "><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"   style="color: white;" href="' . $base_url . '/formlar-review/Form1-Solunumgereksinimi-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form1 Solunum Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table17_data') {
                                        $form_id = $form["form_id"];
                                    ...
                                    if ($key ===  'table18_data') {
                                        ...
                                        $update_date = $form["creation_date"];
                                        $form_19_options .= '<li class="m-2 p-2 "><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"   style="color: white;" href="' . $base_url . '/formlar-review/Form1-Vucudu-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form1 Vucut Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table19_data') {
                                        $form_id = $form["form_id"];
                                        $root20_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_20_options .= '<li class="m-2 p-2 "><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"   style="color: white;" href="' . $base_url . '/formlar-review/Form1-Katerer-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form1 Katerer Date: ' . $update_date . '</p></a></div></li>';                                    }
                                 
                                    if ($key ===  'table20_data') {
                                        $form_id = $form["form_id"];
                                        $root21_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_21_options .= '<li class="m-2 p-2 "><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"   style="color: white;" href="' . $base_url . '/formlar-review/Form1-Iletisim-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form1 Ilestim Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table21_data') {
                                        $form_id = $form["form_id"];
                                        $root22_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_22_options .= '<li class="m-2 p-2 "><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"   style="color: white;" href="' . $base_url . '/formlar-review/Form1-Calisma-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form1 Calisma Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table23_data') {
                                        $form_id = $form["form_id"];
                                        $root24_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_24_options .= '<li class="m-2 p-2 "><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"  style="color: white;" href="' . $base_url . '/formlar-review/Form1-bosaltim-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form1 Bosaltim Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table22_data') {
                                        $form_id = $form["form_id"];
                                        $root23_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_23_options .= '<li class="m-2 p-2 "><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"   style="color: white;" href="' . $base_url . '/formlar-review/Form1-egitim-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form1 Egitim Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table24_data') {
                                        $form_id = $form["form_id"];
                                        $root25_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_25_options .= '<li class="m-2 p-2 "><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"   style="color: white;" href="' . $base_url . '/formlar-review/Form1-beslenme-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form1 Beslenme Date: ' . $update_date . '</p></a></div></li>';
                                    }
                                    if ($key ===  'table25_data') {
                                        $form_id = $form["form_id"];
                                        $root26_id = $form["form_id"];
                                        $update_date = $form["creation_date"];
                                        $form_26_options .= '<li class="m-2 p-2 "><div class="entered-forms align-items-center"><a class="nav-items review btn btn-success p-3"   style="color: white;" href="' . $base_url . '/formlar-review/Form1-uyku-review.php?display=0&form_id=' . $form_id . '&patient_id=' . $patient_id . '&patient_name=' . $patient_name . '&student_id=' . $student_id . '&student_name='.$student_name.'"><p class="entered-forms-p">Form1 Uyku Date: ' . $update_date . '</p></a></div></li>';
                                    }
