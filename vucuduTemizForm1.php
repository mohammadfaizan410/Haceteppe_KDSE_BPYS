                            ...
                            <tr>
                                <td class="protezlertable">
                                    <div class="form-check form-check-inline">
                                        ...
                                        value="option1">
                                        <label class="form-check-label" for="inlineCheckbox1">Sarı. Yeri… </label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="protezlertable">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                        value="option1">
                                        <label class="form-check-label" for="inlineCheckbox1">Soluk Yeri</label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="protezlertable">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                        value="option1">
                                        <label class="form-check-label" for="inlineCheckbox1">Siyanoz. Yeri</label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="protezlertable">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                        value="option1">
                                        <label class="form-check-label" for="inlineCheckbox1">Renk kaybı</label>
                                    </div>
                                </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                        value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Makül </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                        value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Papül </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                        value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Vezikül </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                    value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Yağlı </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                    value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Sert </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                    value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Seyrek </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                    value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Tüylenmede Artış</label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                    value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1"> Kuruma </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                    value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Yağlanma  </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                    value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Kitle. Açıklayınız</label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                    value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Soluk beyaz</label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                    value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Sarı  </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                    value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">  Çomaklaşma  </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                    value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Beyaz lekeler</label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="protezlertable">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                    value="option1">
                                    <label class="form-check-label" for="inlineCheckbox1">Paronişya </label>
                                </div>
                            </td>
