...
<body>
    ...
    <div class='option mt-3 p-3' id='sendToAll'>
        <h4 class='btn btn-primary w-100 p-4 text-start dark-blue' style="background-color: slateblue;">Tüm öğrencilere
            mesaj gönder</h4>
    </div>
    <div class='option mt-3 p-3' id='sendToSome'>
        <h4 class='btn btn-primary  w-100 p-4 text-start dark-blue' style="background-color: slateblue;">Seçilen
            öğrencilere mesaj gönder</h4>
    </div>
    <div class='option mt-3 p-3' id='showAllMessages'>
        <h4 class='btn btn-primary  w-100 p-4 text-start dark-blue' style="background-color: slateblue;">Tüm mesajları
            göster</h4>
    </div>
    ...
    box-shadow: 40px 40px 40px 40px rgb(112 144 176 / 18%);">
        ...
        <div class="broadcastPrompt w-50 h-50 d-flex justify-content-center flex-column m-auto">
            <p>Konu Giriniz:</p>
            <input type="text" class="form-control mb-3" placeholder="Konu Giriniz" id="broadcastSubject"
                maxlength="200"></input>
            <p>Mesaj Yazınız:</p>
            <textarea type='text-area' rows="10" class='form-control mb-5' placeholder="Mesaj Yazınız"
                id="broadcastMessage" maxlength="10000"> </textarea>
            <p id="error"></p>
            <div class="text-center m-auto p-3 w-50 d-flex justify-content-between" style="    margin: unset !important;
    align-self: center;
    gap: 20px;
    width: 100% !important;     padding: unset !important;">
                <div class='btn btn-primary p-3' style="background-color: slateblue;" id='close-broadcast-container'>
                    Kapat</div>
    ...
    box-shadow: 40px 40px 40px 40px rgb(112 144 176 / 18%);">
        <div class="broadcastPrompt w-50 h-50 d-flex justify-content-center flex-column m-auto">
            <p>Konu Giriniz:</p>
            <input type="text" class="form-control mb-3" placeholder="Konu Giriniz" id="multicastSubject"
                maxlength="200"></input>
            <p>Mesaj Yazınız:</p>
            <textarea type='text-area' rows="10" class='form-control mb-5' placeholder="Mesaj Yazınız"
                id="multicastMessage" maxlength="10000"> </textarea>
            ...
            <div class="messaging-buttons text-center m-auto p-3 w-50 d-flex justify-content-between " style="    margin: unset !important;
    align-self: center;
    gap: 20px;
    width: 100% !important;     padding: unset !important;">

                <div class='btn btn-primary p-3' style="background-color: slateblue;" id='close-multicast-container'>
                    Kapat</div>
                <div class="btn btn-primary p-3" style="background-color: slateblue;" id="sendMulticast">Gönder</div>
            </div>
        </div>
    </div>
