...
<body>
  ...
  ?>
    ...
    <div class="searchbar d-flex justify-content-center align-items-center">
        <input type="text" class="form-control w-50" placeholder="search for student or teacher by emailr"
            id="searchValue" aria-describedby="basic-addon1">
    ...
    $(function() {
        $("#submit-search").click(function(e) {
            ...
            if (nameOrEmail !== "") {
                $.ajax({
                    type: 'POST',
                    url: 'http://18.159.134.238/Hacettepe-KDSE-BPYS/process-search.php/?' +
                            ...
                            JSON.parse(data).forEach(element => {
                                if (element.email === myEmail) {
                                    ...
                                    $(".searchResults").html(
                                        ...
                                        element.surname +
                                        "'><button type='button' class='btn btn-primary p-3 mt-3'>View Conversation</button></a></div>"
                                        );
                            })
                        } else {
                            $(".searchResults").html(
