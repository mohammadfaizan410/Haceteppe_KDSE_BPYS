...
if (isset($_POST)) {
    ...
    if ($rowCount > 0) {
        ...
        WHERE patient_id = ?");
        $result = $stmt->execute([$update_date, $problem_info, $nurse_description, $noc_output, $noc_indicator, $noc_indicator, $nurse_attempt, $nurse_education,$collaborative_applications, $evaluation, $matchedfields_string, $patient_id]);
        if ($result) {
