                        ...
                        <div class="input-section d-flex">
                            ...
                            <div class="form-check">
                                <div class="input-section d-flex">
                                    ...
                                    <input type="int" class="form-control" required name="length" id="length" placeholder="Uzunluk Giriniz" maxlength = "3">
                                </div>
                                <div class="input-section d-flex">
                                    <p class="usernamelabel">Genişlik:</p>
                                    <input type="int" class="form-control" required name="width" id="width" placeholder="Genişlik Giriniz" maxlength = "3">
                                </div>
                                <div class="input-section d-flex">
                                    <p class="usernamelabel">Derinlik:</p>
                                    <input type="int" class="form-control" required name="depth" id="depth" placeholder="Derinlik Giriniz" maxlength = "3">
                                </div>
                            </div>
                        </div>
