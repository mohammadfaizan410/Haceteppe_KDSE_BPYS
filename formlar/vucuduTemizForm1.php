                    ...
                    <div class="input-section d-flex">
                        ...
                        <div class="checkbox-wrapper d-flex">
                            <div class="checkboxes d-flex">
                                <div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="skinStructure" id="skinStructure" value="Normal">
                                        <label class="form-check-label" for="DerininYapisi">
                                            <span class="checkbox-header">Normal </span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="skinStructure" id="skinStructure" value="Pürüzlü">
                                        <label class="form-check-label" for="DerininYapisi">
                                ...
                                <div>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="skinStructure" id="skinStructure" value="Sert">
                                        <label class="form-check-label" for="DerininYapisi">
                                            <span class="checkbox-header">Sert</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="skinStructure" id="skinStructure" value="Esnek">
                                        <label class="form-check-label" for="DerininYapisi">
                                ...
                                <div>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="skinStructure" id="skinStructure" value="Buruşuk">
                                        <label class="form-check-label" for="DerininYapisi">
                                            <span class="checkbox-header">Buruşuk</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="skinStructure" id="skinStructure" value="İnce">
                                        <label class="form-check-label" for="DerininYapisi">
