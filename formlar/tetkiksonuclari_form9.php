                ...
                <div class="patients-save">
                    <form action="" method="POST" class="patients-save-fields">
                        ...
                        <div class="input-section d-flex">
                            ...
                            <input type="text" class="form-control" required name="examination_result" id="diger" placeholder="Tetkik Sonucu" maxlenght = "2000">
                        </div>
                        <div class="input-section d-flex">
                            <p class="usernamelabel">Referans Değeri :</p>
                            <input type="text" class="form-control" required name="referance_value" id="diger" placeholder="Referans Değeri" maxlenght = "200">
                        </div>
