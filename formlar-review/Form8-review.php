                    ...
                    <form action="" method="POST" class="patients-save-fields">
                        ...
                        <div class="input-section d-flex">
                            ...
                            <input type="text" class="form-control" required name="patient_name" id="diger"
                                placeholder="Patient Name" value="<?php echo $form8[0]['patient_name']; ?>" disabled>
                        </div>
                        ` <div class="input-section d-flex">
                            <p class="usernamelabel">Patient ID:</p>
                            <input type="text" class="form-control" required name="patient_id" id="diger"
                                placeholder="Patient ID" value="<?php echo $form8[0]['patient_id']; ?>" disabled>
                        </div>
                        <div class="input-section d-flex" style="padding-top: 5%;">
                            <p class="usernamelabel">Değerlendirilen Alan:</p>
                            <input type="text" class="form-control" required name="assessed_area" id="diger"
                                placeholder="Değerlendirilen Alanı Giriniz"
                                value="<?php echo $form8[0]['assessed_area']; ?>">
                        </div>
                        ...
                        <div class="input-section d-flex">
                            ...
                            <div class="form-check">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="ÖdemŞiddeti" id="ÖdemŞiddeti1"
                                        value="Ödem Yok">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="ÖdemŞiddeti" id="ÖdemŞiddeti2"
                                        value="1">
                                    <label class="form-check-label" for="ÖdemŞiddeti">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="ÖdemŞiddeti" id="ÖdemŞiddeti3"
                                        value="2">
                                    <label class="form-check-label" for="ÖdemŞiddeti">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="ÖdemŞiddeti" id="ÖdemŞiddeti4"
                                        value="3">
                                    <label class="form-check-label" for="ÖdemŞiddeti">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="ÖdemŞiddeti" id="ÖdemŞiddeti5"
                                        value="4">
                                    <label class="form-check-label" for="ÖdemŞiddeti">
