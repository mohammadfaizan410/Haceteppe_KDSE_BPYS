                    ...
                    <form action="" method="POST" class="patients-save-fields">
                        ...
                        <div class="input-section d-flex">
                            ...
                            <div class="form-check">
                                ...
                                <div class="input-section d-flex">
                                    ...
                                    <input type="text" class="form-control" required name="depth" id="depth"
                                        placeholder="Derinlik Giriniz">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="input-section d-flex">
                            ...
                            <input type="text" class="form-control" required name="diger" id="wound-exudate"
                                placeholder="Yara Eksudasını Giriniz">
                        </div>
                        ...
                        <div class="input-section d-flex">
                            ...
                            <input type="text" class="form-control" required name="odor" id="odor"
                                placeholder="Koku Durumunu Giriniz">
                        </div>
                        ...
                        <div class="input-section d-flex">
                            ...
                            <input type="text" class="form-control" required name="edema" id="edema"
                                placeholder="Ödem Durumunu Giriniz">
                        </div>
