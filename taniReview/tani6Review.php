...
if (isset($_GET['patient_id'])) {
    ...
    $stmt = $db->prepare("SELECT * from tani6 where patient_id = ?");
            ...
            <div class="input-section-item">
                                ...
                                <div class="form-check">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator2"
                                            disabled id="noc_indicator2" checked>
                                        <label class="form-check-label" for="noc_indicator2">
                                            <span
                                                class="checkbox-header"><?php echo "$taniData[0]['noc_indicator2']" ?></span>
                                        </label>
                                    </div>
                                ...
                                <div class="form-check">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator3"
                                            disabled id="noc_indicator3" checked>
                                        <label class="form-check-label" for="noc_indicator3">
                                            <span
                                                class="checkbox-header"><?php echo "$taniData[0]['noc_indicator3']" ?></span>
                                        </label>
                                    </div>
                        ...
                        <div class="form-check">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" required name="noc_indicator_after"
                                    disabled id="noc_indicator_after" checked>
                ...
                <div class="input-section" id="o2-delivery-container">
                    ...
                    <div class="form-check">
                        <div class="form-check">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" required name="noc_indicator2_after"
                                    disabled id="noc_indicator2_after" checked>
                                <label class="form-check-label" for="noc_indicator2_after">
                                    <span
                                        class="checkbox-header"><?php echo "$taniData[0]['noc_indicator2_after']" ?></span>
                                </label>
                            </div>
                ...
                <div class="input-section" id="o2-delivery-container">
                    ...
                    <div class="form-check">
                        <div class="form-check">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" required name="noc_indicator3_after"
                                    disabled id="noc_indicator3_after" checked>
                                <label class="form-check-label" for="noc_indicator3_after">
                                    <span
                                        class="checkbox-header"><?php echo "$taniData[0]['noc_indicator3_after']" ?></span>
                                </label>
                            </div>
