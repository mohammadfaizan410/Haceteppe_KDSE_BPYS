...
if (isset($_GET['patient_id'])) {
    ...
    if ($result) {
        $tani17Data = $stmt->fetchAll(PDO::FETCH_ASSOC);
    }
}
                    ...
                    <form action="" method="POST" class="patients-save-fields">
                        <div class="input-section d-flex">
                            ...
                            <div class="matchedfields-wrapper">
                                <?php
                                $innerHtml = '';
                                $fieldsArray = explode("/", $tani17Data[0]["matchedfields_string"]);
                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <?php
                            $nurse_attempt = explode("/", $tani17Data[0]['nurse_attempt']);
                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <?php
                            $nurse_education = explode("/", $tani17Data[0]['nurse_education']);
                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <?php
                            $collaborative_applications = explode("/", $tani17Data[0]['collaborative_applications']);
