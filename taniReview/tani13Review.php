...
if (isset($_GET['patient_id'])) {
    ...
    if ($result) {
        $tani13Data = $stmt->fetchAll(PDO::FETCH_ASSOC);
    }
}
                    ...
                    <form action="" method="POST" class="patients-save-fields">
                        <div class="input-section d-flex">
                            ...
                            <div class="matchedfields-wrapper">
                                <?php
                                $innerHtml = '';
                                $fieldsArray = explode("/", $tani13Data[0]["matchedfields_string"]);
                            ...
                            <div class="form-check">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="noc_indicator">
                                        <span class="checkbox-header"><?php echo $tani13Data[0]['noc_indicator']?></span>
                                    </label>
                                </div>
                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <?php
                            $nurse_attempt = explode("/", $tani13Data[0]['nurse_attempt']);
                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <?php
                            $nurse_education = explode("/", $tani13Data[0]['nurse_education']);
                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <?php
                            $collaborative_applications = explode("/", $tani13Data[0]['collaborative_applications']);
                        ...
                        <div class="input-section d-flex" id="o2-delivery-container">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="noc_indicator">
                                        <span class="checkbox-header"><?php echo $tani13Data[0]['noc_indicator_after']?></span>
                                    </label>
                                </div>
