...
<body>
    <div class="container-fluid pt-4 px-4" style="overflow: hidden;">
        <div class="send-patient w-100" style="overflow: hidden;">
            ...
            <div class="w-100 p-4">
                <button class="btn btn-success mb-3 w-50 p-3" id="send-to-student">Öğrencilere mesaj gönderme</button>
                <div id="send-to-student-dropdown" class="input-section" style="display: none;">
                    ...
                    <div class="d-flex justify-content-around">
                        ...
                        <button class="btn btn-success w-25 m-3" id="student-selection">Öğrenci Seç</button>
                    </div>
                    ...
                    <button class="btn btn-success w-100" id="send-message-students">Gönder</button>
                </div>
            </div>
            <div class="w-100 p-4">
