        ...
        <div class="send-patient ta-center">
                            ...
                            <table class="ozgecmistable-wrapper">
                                <tbody>
                                    <tr>
                                        <td class="protezlertable">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="diyetinlineCheckbox1"
                                                    value="option1">
                                    ...
                                    <tr>
                                        ...
                                        <td class="protezlertable">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox2"
                                                    value="option2">
                                                <label class="form-check-label" for="inlineCheckbox2">Özel  Diyet(Açıklayınız): 
                                                </label>
                                                <input type="text" class="form-control ozgecmistable" required
                                                    name="beslenmeOzelDiyet" id="beslenmeOzelDiyet">
                                            </div>
                                        </td>
                                        ...
                                        <td class="protezlertable">
                                            <div class="d-flex">
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    for="inlineCheckbox1">Nazogastrik </label>
                                                </div>
                                                <div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                                        value="option1">
                                                        <label class="form-check-label"
                                                        for="inlineCheckbox1">sağ nazal pasaj / Takılma Tarihi:</label>
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        value="option1">
                                                        <label class="form-check-label"
                                                        for="inlineCheckbox1">sol nazal pasaj / Takılma Tarihi </label>
                                                        <input type="text" class="form-control" required name="beslenmeSivi" id="beslenmeSiviTuketimi">
                                                    </div>
                                                </div>
                                                </div>
            ...
            <div class="input-section d-flex">
                <p class="usernamelabel">                    
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="cignemeRadio" id="cignemeRadio"
                            value="option1">
            ...
            <div class="input-section d-flex">
                ...
                <div class="checkbox-wrapper d-flex">
                    <div class="checkboxes d-flex">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="beslenmeiledurumuradio" id="beslenmeileradio"
                                value="option1">
                                        ...
                                        <tr>
                                            <td class="protezlertable">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                                    value="option1">
                                                    <label class="form-check-label" for="inlineCheckbox1">Kötü Koku</label>
                                                </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="protezlertable">
                                            <div class="form-check form-check-inline">
                                                ...
                                                value="option1">
                                                <label class="form-check-label" for="inlineCheckbox1">Diş ağrısı </label>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="protezlertable">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox5"
                                                value="option1">
                                                <label class="form-check-label" for="inlineCheckbox1">Eksik Diş </label>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="protezlertable">
                                            <div class="form-check form-check-inline">
                                                ...
                                                value="option1">
                                                <label class="form-check-label" for="inlineCheckbox1">Dişeti ödemi</label>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="protezlertable">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                                value="option1">
                                                <label class="form-check-label" for="inlineCheckbox1">Ödem </label>
                                            </div>
                                        </td>
                                        ...
                                        <tr>
                                            <td class="protezlertable">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                                    value="option1">
                                                    <label class="form-check-label" for="inlineCheckbox1">Enfeksiyon (Sağ/sol)</label>
                                                </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="protezlertable">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                                value="option1">
                                                <label class="form-check-label" for="inlineCheckbox1">Lezyon (Sağ/sol)</label>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="protezlertable">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                                value="option1">
                                                <label class="form-check-label" for="inlineCheckbox1">Ödem (Sağ/sol)</label>
                                            </div>
                                        </td>
            ...
            <div>
                ...
                <div class="input-section d-flex">
                    ...
                    <div class="checkbox-wrapper d-flex">
                        <div class="checkboxes d-flex">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="beslenmeabdominalradio" id="beslenmeabdominalradio"
                                value="option1">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="beslenmeabdominalradio">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="beslenmeabdominalradio2" id="beslenmeabdominalradio2"
                                value="option1">
                ...
                <div class="input-section d-flex">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="beslenmeiledurumuradio" id="beslenmeabdominalumuradio"
                        value="option2">
                        <label class="form-check-label" for="beslenmeabdominalumuradio">
