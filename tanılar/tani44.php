  ...
  <div id="tick"></div>
    ...
    <script>
        $(document).ready(function(){
            $('#hyperthermia_val1').prop('disabled', true);
            $('#hyperthermia_val2').prop('disabled', true);
            $('#hyperthermia_val3').prop('disabled', true);
            $('#hypothermia_val1').prop('disabled', true);
            $('#hypothermia_val2').prop('disabled', true);
            $('#hypothermia_val3').prop('disabled', true);
