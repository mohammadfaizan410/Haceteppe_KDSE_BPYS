                    ...
                    <form action="" method="POST" class="patients-save-fields">
                        ...
                        <div class="input-section" id="o2-delivery-container">
                            ...
                            <div class="form-check">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator" id="noc_indicator" value="1: Hastanın periferik nabızları hiç hissedilmiyor">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator" id="noc_indicator" value="2: Hastanın periferik nabızları büyük ölçüde hissedilmiyor">
                                    <label class="form-check-label" for="noc_indicator">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator" id="noc_indicator" value="3: Hastanın periferik nabızları zor hissediliyor">
                                    <label class="form-check-label" for="noc_indicator">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator" id="noc_indicator" value="4: Hastanın periferik nabızları biraz zayıf hissediliyor">
                                    <label class="form-check-label" for="noc_indicator">
                        ...
                        <div class="input-section" id="o2-delivery-container">
                            ...
                            <div class="form-check">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator2" id="noc_indicator2" value="1: Hastanın idrarı ileri derecede yoğundur">
                                    <label class="form-check-label" for="noc_indicator2">
                                        <span class="checkbox-header">1: Hastada şiddetli düzeyde ödem var </span>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator2" id="noc_indicator2" value="2: Hastanın idrarı yoğundur">
                                    <label class="form-check-label" for="noc_indicator2">
                                        <span class="checkbox-header">2: Hastada önemli düzeyde ödem var</span>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator2" id="noc_indicator2" value="3: Hastanın idrarı orta düzeyde yoğundur">
                                    <label class="form-check-label" for="noc_indicator2">
                        ...
                        <div class="input-section" id="o2-delivery-container">
                            ...
                            <div class="form-check">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator3" id="noc_indicator3" value="1: Hastanın kapiller dolum süresinde çok uzama var">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator3" id="noc_indicator3" value="2: Hastanın kapiller dolum süresinde büyük ölçüde uzama var">
                                    <label class="form-check-label" for="noc_indicator3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator3" id="noc_indicator3" value="3: Hastanın kapiller dolum süresinde orta düzeyde uzama var">
                                    <label class="form-check-label" for="noc_indicator3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator3" id="noc_indicator3" value="4: Hastanın kapiller dolum süresinde biraz uzama var">
                                    <label class="form-check-label" for="noc_indicator3">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="noc_indicator3">
                                        <span class="checkbox-header">5: Hastanın kapiller dolum süresi normal (< 3 sn)</span>
                                    </label>
                                </div>
                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt1" value="Periferik dolaşım (nabızlar, ödem, kapiller dolum, renk, sıcaklık) değerlendirilir ">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt2" value="Sıvı dengesinin değerlendirilmesi için Aldığı-Çıkardığı takibi yapılır ">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt3" value="Duyu değerlendirmesi (keskin, künt, sıcak, soğuk) yapılır">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt4" value="Ekstremiteler hissizlik, karıncalanma, aşırı duyarlılık, duyularda azalma açılarından değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt5" value="Ayakkabı, çorap, terlik, giysilerin ve varsa protezlerin hastaya uyumu kontrol edilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt6" value="Laboratuvar bulguları (PTZ, a-PTT, Trombosit sayısı, serum elektrolitleri) değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt8" value="Etkilenmiş ekstremitenin kimyasal, mekanik ya da termal travmalardan korunması sağlanır">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt9" value="Hastanın periferik nabızları değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Hastanın periferik nabızları değerlendirilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt10" value="Hastanın kapiller dolum süresi değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Hastanın kapiller dolum süresi değerlendirilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt11" value="Hastanın ekstremitelerinin rengi ve sıcaklığı değerlendirilir ">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt12" value="Gerektiğinde ekstremiteler ısıtılır">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Gerektiğinde ekstremiteler ısıtılır</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt13" value="Hasta trombofilebit veya tromboembolizim açısından izlenir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt14" value="Sıvı yüklenmesi ve retansiyonu ile ilgili bulgular (CVP Artışı, ödem, boyun venlerinde dolgunluk, asit vb.) değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt15" value="Ödem değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Ödem değerlendirilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt16" value="Ödemli bölge cilt bütünlüğü açısından değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt17" value="Gerektiğinde ekstremite elevasyona alınır">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt18" value="Hasta ve bakım verenlerine egzersizin periferik dolaşıma etkisi hakkında bilgi verilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt19" value="Hasta ve bakım verenleri yatak istirahati sırasında özellikle alt ekstremiteye pasif/aktif ROM egzersizlerinin yaptırılması konusunda desteklenir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt20" value="Hasta ve bakım verenleri ekstremite sıcaklık değerlendirmesi, diyet ve ilaç kullanımına uyum, venöz staz oluşumunu önleme (bacak bacak üzerine atmama, dizleri bükmeme, egzersiz) konularında bilgilendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt21" value="Hasta ve bakım verenlerine ayak bakımı konusunda (ayakların düzenli olarak yıkanması, kurulanması, ayak derisinin uygun şekilde nemlendirilmesi, tırnakların düz kesilip törpülenmesi gibi) bilgi verilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt22" value="Hasta ve bakım verenlerine banyo yaparken, otururken, uzanırken ya da pozisyon değiştirirken vücut bölümlerini izlemesi konusunda bilgi verilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt23" value="Hasta ve bakım verenleri deri bütünlüğünde görülen değişimler için cildin günlük olarak incelenmesi konusunda bilgilendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt24" value="Hasta ve bakım verenleri sıcak ya da soğuk uygulamalar sırasında gelişebilecek komplikasyonlar hakkında bilgilendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt25" value="İstem yapılan sıvılar ve  ilaçlar (analjezik, antikoagülan, vazodilatör, diüretikler vb) uygulanır ">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt26" value="Sodyumdan kısıtlı diyet sağlanması konusunda diyetisyenle iş birliği yapılır">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt27" value="Sigara bırakma konusunda bilgilendirilir ve ilgili birimlere yönlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                        ...
                        <div class="input-section d-flex">
                            ...
                            <div class="input-section" id="o2-delivery-container">
                                ...
                                <div class="form-check">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator_after" id="noc_indicator_after" value="1: Hastanın periferik nabızları hiç hissedilmiyor">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator_after" id="noc_indicator_after" value="2: Hastanın periferik nabızları büyük ölçüde hissedilmiyor">
                                        <label class="form-check-label" for="noc_indicator_after">
                                            <span class="checkbox-header">2: Hastanın periferik nabızları büyük ölçüde
                                                hissedilmiyor</span>
                                        </label>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator_after" id="noc_indicator_after" value="3: Hastanın periferik nabızları zor hissediliyor">
                                        <label class="form-check-label" for="noc_indicator_after">
                                            <span class="checkbox-header">3: Hastanın periferik nabızları zor
                                                hissediliyor</span>
                                        </label>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator_after" id="noc_indicator_after" value="4: Hastanın periferik nabızları biraz zayıf hissediliyor">
                                        <label class="form-check-label" for="noc_indicator_after">
                                            <span class="checkbox-header">4: Hastanın periferik nabızları biraz zayıf
                                                hissediliyor</span>
                                        </label>
                            ...
                            <div class="input-section" id="o2-delivery-container">
                                ...
                                <div class="form-check">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator2_after" id="noc_indicator2_after" value="1: Hastanın idrarı ileri derecede yoğundur">
                                        <label class="form-check-label" for="noc_indicator2_after">
                                            <span class="checkbox-header">1: Hastada şiddetli düzeyde ödem var </span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator2_after" id="noc_indicator2_after" value="2: Hastanın idrarı yoğundur">
                                        <label class="form-check-label" for="noc_indicator2_after">
                                            <span class="checkbox-header">2: Hastada önemli düzeyde ödem var</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator2_after" id="noc_indicator2_after" value="3: Hastanın idrarı orta düzeyde yoğundur">
                                        <label class="form-check-label" for="noc_indicator2_after">
                                            <span class="checkbox-header">3: Hastada orta düzeyde ödem var </span>
                                        </label>
                                    </div>
                            ...
                            <div class="input-section" id="o2-delivery-container">
                                ...
                                <div class="form-check">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator3_after" id="noc_indicator3_after" value="1: Hastanın kapiller dolum süresinde çok uzama var">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator3_after" id="noc_indicator3_after" value="2: Hastanın kapiller dolum süresinde büyük ölçüde uzama var">
                                        <label class="form-check-label" for="noc_indicator3_after">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator3_after" id="noc_indicator3_after" value="3: Hastanın kapiller dolum süresinde orta düzeyde uzama var">
                                        <label class="form-check-label" for="noc_indicator3_after">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator3_after" id="noc_indicator3_after" value="4: Hastanın kapiller dolum süresinde biraz uzama var">
                                        <label class="form-check-label" for="noc_indicator3_after">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator3_after" id="
                                        noc_indicator3_after" value="5: Hastanın kapiller dolum süresi normal (< 3 sn)">
                                        <label class="form-check-label" for="noc_indicator3_after">
                                            <span class="checkbox-header">5: Hastanın kapiller dolum süresi normal (< 3 sn)</span>
                                        </label>
                                    </div>
