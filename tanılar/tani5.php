                            ...
                            <div class="form-check">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator"
                                        id="noc_indicator" value="1:Hastada çok şiddetli düzeyde sıvı yüklenmesi var">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator"
                                        id="noc_indicator" value="2: Hastada şiddetli düzeyde sıvı kaybı var ">
                                    <label class="form-check-label" for="noc_indicator">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator"
                                        id="noc_indicator" value="3:Hastada orta düzeyde sıvı yüklenmesi var">
                                    <label class="form-check-label" for="noc_indicator">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator"
                                        id="noc_indicator" value="4:Hastada hafif düzeyde sıvı yüklenmesi var">
                                    <label class="form-check-label" for="noc_indicator">
                            ...
                            <div class="form-check">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator2"
                                        id="noc_indicator2" value="1: Hastada şiddetli düzeyde ödem var ">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator2"
                                        id="noc_indicator2" value="2: Hastada önemli düzeyde ödem var">
                                    <label class="form-check-label" for="noc_indicator2">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator2"
                                        id="noc_indicator2" value="3: Hastada orta düzeyde ödem var ">
                                    <label class="form-check-label" for="noc_indicator2">
                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt1"
                                    value="Hasta pulmoner (solunum sıkıntısının artması) ve kardiyovasküler (nabız hızının artması, KB nın artması, vb) komplikasyonlar açısından değerlendirilir ">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt2"
                                    value="Sıvı yüklenmesi ve retansiyonu ile ilgili bulgular (CVP artışı, boyun venlerinde dolgunluk, asit vb.) değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt3"
                                    value="Sıvı retansiyonu ile ilgili laboratuvar bulguları (BUN düzeyinin artması, HCT düzeyinin azalması, idrar osmaolaritesinin artması, serum elektrolitlerinde değişim) değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Sıvı retansiyonu ile ilgili laboratuvar bulguları (BUN
                                        düzeyinin artması, HCT düzeyinin azalması, idrar osmaolaritesinin artması, serum
                                        elektrolitlerinde değişim) değerlendirilir</span>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt4"
                                    value="Ödem değerlendirmesi (yeri, derecesi) yapılır ">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt5"
                                    value="Ödemli bölge cilt bütünlüğü açısından değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt6"
                                    value="Venöz dönüşü arttırmak için ödemli ekstremite elevasyona alınır">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt8"
                                    value="Sıvı kısıtlaması uygun şekilde yapılır">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt"
                                    id="nurse_attempt11"
                                    value="Abdomen veya ekstremite çevresi düzenli olarak ölçülüp, kaydedilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt"
                                    id="nurse_attempt12"
                                    value="Hasta ve bakım verenleri sıvı volüm fazlalığı belirtileri ve bulguları hakkında bilgilendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt"
                                    id="nurse_attempt13"
                                    value="Hasta ve bakım verenlerine ödem nedenleri ve çözümleri hakkında bilgi verilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt"
                                    id="nurse_attempt14"
                                    value="Oral kısıtlaması olan hastaya, kısıtlamanın nedenleri hakkında bilgi verilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt"
                                    id="nurse_attempt15"
                                    value="Proteinden zengin, sodyumdan kısıtlı diyet sağlanması konusunda diyetisyenle iş birliği yapılır">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt"
                                    id="nurse_attempt16"
                                    value="Antiembolitik çorap ve bandaj kullanımının uygunluğu konusunda hekimle iletişime geçilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt"
                                    id="nurse_attempt17" value="İstem yapılan ilaçlar (diüretikler vb) uygulanır">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt"
                                    id="nurse_attempt18" value="Gerekli ise diyaliz uygulanır">
                                <label class="form-check-label" for="nurse_attempt">
                                ...
                                <div class="form-check">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator_after"
                                            ...
                                            value="1:Hastada çok şiddetli düzeyde sıvı yüklenmesi var">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator_after"
                                            id="noc_indicator_after"
                                            value="2: Hastada şiddetli düzeyde sıvı kaybı var ">
                                        <label class="form-check-label" for="noc_indicator_after">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator_after"
                                            id="noc_indicator_after" value="3:Hastada orta düzeyde sıvı yüklenmesi var">
                                        <label class="form-check-label" for="noc_indicator_after">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator_after"
                                            id="noc_indicator_after"
                                            value="4:Hastada hafif düzeyde sıvı yüklenmesi var">
                                        <label class="form-check-label" for="noc_indicator_after">
                                ...
                                <div class="form-check">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required
                                            ...
                                            value="1: Hastada şiddetli düzeyde ödem var ">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required
                                            name="noc_indicator2_after" id="noc_indicator2_after"
                                            value="2: Hastada önemli düzeyde ödem var">
                                        <label class="form-check-label" for="noc_indicator2_after">
                                            <span class="checkbox-header">2: Hastada önemli düzeyde ödem var</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required
                                            name="noc_indicator2_after" id="noc_indicator2_after"
                                            value="3: Hastada orta düzeyde ödem var ">
                                        <label class="form-check-label" for="noc_indicator2_after">
                                            <span class="checkbox-header">3: Hastada orta düzeyde ödem var </span>
                                        </label>
                                    </div>
