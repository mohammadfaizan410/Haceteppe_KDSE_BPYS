                            ...
                            <div class="form-check">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator2"
                                        id="noc_indicator2" value="1:  Hasta hiç balgam çıkartmıyor ">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator2"
                                        id="noc_indicator2" value="2: Hasta nadiren balgam çıkartıyor">
                                    <label class="form-check-label" for="noc_indicator2">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator2"
                                        id="noc_indicator2" value="3. Hasta bazen balgam çıkartıyor">
                                    <label class="form-check-label" for="noc_indicator2">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator2"
                                        id="noc_indicator2" value="4: Hasta sık sık balgam çıkartıyor">
                                    <label class="form-check-label" for="noc_indicator2">
                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt4"
                                    value="Hastanın öksürmesi ve sekresyonlarının miktarı ve niteliği değerlendirilir ">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt5"
                                    value="Hastanın solunum sesleri değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt7"
                                    value="Sekresyonların yoğunluğunu azaltmak için uygun hidrasyon sağlanır">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt8"
                                    value="Aspirasyon ihtiyacı değerlendirilir, gerektiğinde hasta aspire edilir ">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt"
                                    id="nurse_attempt12"
                                    value="Hasta ve bakım verenlerine balgamdaki renk, koku, miktar ve nitelik değişimlerinin anlamı ve önemi konusunda ">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt"
                                    id="nurse_attempt15"
                                    value="Hastada cerrahi insizyon var ise, öksürürken insizyon bölgesini nasıl destekleyeceği konusunda bilgi verilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt"
                                    id="nurse_attempt16" value="Gerektiğinde solunum terapisti ile işbirliği yapılır">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt"
                                    id="nurse_attempt18"
                                    value="Perküsyon uygulaması ya da destekleyici ekipman kullanımının uygunluğu için hekimle iletişime geçilir">
                                <label class="form-check-label" for="nurse_attempt">
                                ...
                                <div class="form-check">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required
                                            name="noc_indicator2_after2" id="noc_indicator2_after2"
        ...
        $('#submit').click(function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    alert(data);
                    let url =
                        "<?php echo $base_url; ?>/taniReview/tani3Review.php?patient_id=" +
