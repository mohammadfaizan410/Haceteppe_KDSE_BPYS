                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt2"
                                    value="Kronik ağrının hastanın yaşam üzerine (sosyal etkileşimler, ekonomik durum, uyku, yeme, hareket etme gibi) etkileri değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt4"
                                    value="Ağrı kontrolünü kolaylaştırmak için yeterli dinlenme ve uyku sağlanır">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt6"
                                    value="Hasta ve bakım verenlerine narkotik veya opioid analjezikler kullanımı ve toplumda var olan yanlış düşünceler (bağımlılık, aşırı doz riski gibi) hakkında eğitim verilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt7"
                                    value="Hasta ve bakım verenlerine ağrının tamamen giderilemeyebileceği bilgisi verilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt8"
                                    value="İstemde yer alan ilaçlar (analjezikler, opioidler vb) uygulanır">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt9"
                                    value="Hasta ve bakım verenleri destek gruplarına ve diğer kaynaklara yönlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
