                ...
                <div class="patients-save">
                    <form action="" method="POST" class="patients-save-fields">
                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt6" value="Hasta ve bakım verenlerine narkotik veya opioid analjezikler kullanımı ve toplumda var olan yanlış düşünceler (bağımlılık, aşırı doz riski gibi) hakkında eğitim verilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt7" value="Hasta ve bakım verenlerine ağrının tamamen giderilemeyebileceği bilgisi verilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt8" value="İstemde yer alan ilaçlar (analjezikler, opioidler vb) uygulanır">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt9" value="Hasta ve bakım verenleri destek gruplarına ve diğer kaynaklara yönlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
    ...
    <script>
        $(function() {
            $('#submit').click(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $base_url; ?>/insertTanalar/tani8Insert.php',
                    data: {
                        name: name,
                        surname: surname,
                        age: age,
                    ...
                    success: function(data) {
                        ...
                        alert(data);
                        let url =
                            "<?php echo $base_url; ?>/taniReview/tani8Review.php?patient_id=" +
