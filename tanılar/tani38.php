                ...
                <div class="patients-save">
                    <form action="" method="POST" class="patients-save-fields">
                        ...
                        <div class="input-section d-flex">
                            ...
                            <p class="tanıdescription">Aspirasyon riski</p>
                        </div>
                        <div class="input-section d-flex">
                            <p id="tani_usernamelabel">NOC Çıktıları:</p>
                            <p class="tanıdescription">Hastada sıvı ve besin aspirasyonunun olmaması</p>
                        </div>
                        <div class="input-section" id="o2-delivery-container">
                            ...
                            <div class="form-check">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="noc_indicator">
                                        <span class="checkbox-header">5: Hastada besin ya da sıvı aspirasyonu yok, risk devam ediyor</span>
                                    </label>
                                </div>
                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt2"
                                    value="Hastanın bilinç durumu, öksürme refleksi, öğürme refleksi ve yutma yeteneği değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Hastanın bilinç durumu, öksürme refleksi, öğürme refleksi ve yutma yeteneği değerlendirilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt3"
                                    value="Beslenme boyunca öksürük, boğulma, siyanoz, hırıltı gibi aspirasyon belirtileri izlenir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Beslenme boyunca öksürük, boğulma, siyanoz, hırıltı gibi aspirasyon belirtileri izlenir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt4"
                                    value="Hastanın beslenme öncesi ve sonrası, ilaç verme öncesi ve sonrası solunumu değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Hastanın beslenme öncesi ve sonrası, ilaç verme öncesi ve sonrası solunumu değerlendirilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt5"
                                    value="Yeme içme sonrası akciğer sesleri dinlenir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Yeme içme sonrası akciğer sesleri dinlenir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt6"
                                    value="Hastaya yemek yerken ve yemekten bir saat sonraya kadar yarı oturur ya da dik oturur pozisyon verilir, bu pozisyon kontraendike ise hastaya yan yatış pozisyonu verilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Hastaya yemek yerken ve yemekten bir saat sonraya kadar yarı oturur ya da dik oturur pozisyon verilir, bu pozisyon kontraendike ise hastaya yan yatış pozisyonu verilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt7"
                                    value="Hastaya yemek azar azar ve küçük parçalarla verilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Hastaya yemek azar azar ve küçük parçalarla verilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt8"
                                    value="Hastanın yiyecekleri daha kolay yutabilmesi için gıdaların kıyamı uygun şekilde hazırlanır">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Hastanın yiyecekleri daha kolay yutabilmesi için gıdaların kıyamı uygun şekilde hazırlanır</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt9"
                                    value="Sıvıyı tolere edemiyorsa kıvam arttırıcı kullanılır">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Sıvıyı tolere edemiyorsa kıvam arttırıcı kullanılır</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt10"
                                    value="İlaçları vermeden önce ezilir ya da parçalara ayırılarak verilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">İlaçları vermeden önce ezilir ya da parçalara ayırılarak verilir </span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt11"
                                    value="Hastaya yutması için zaman tanınır">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Hastaya yutması için zaman tanınır</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt12"
                                    value="Kendi kendine yutkunmayı deneyebilmesi için hastaya olumlu geribildirim sağlanır">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Kendi kendine yutkunmayı deneyebilmesi için hastaya olumlu geribildirim sağlanır</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt13"
                                    value="Hastanın beslenmesinde gerekli ise enjektör kullanılır">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Hastanın beslenmesinde gerekli ise enjektör kullanılır</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt14"
                                    value="Trakeostomili hastalar için yemek süresi ve 1 saat sonrası için cuff şişirilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Trakeostomili hastalar için yemek süresi ve 1 saat sonrası için cuff şişirilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt15"
                                    value="Sonda ile beslenen hastalarda, besleme ve ilaç vermeden önce gastrik rezidü kontrolü yapılır">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Sonda ile beslenen hastalarda, besleme ve ilaç vermeden önce gastrik rezidü kontrolü yapılır</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt16"
                                    value="Sonda ile beslenen hastalarda besleme ve ilaç vermeden önce enteral beslenme tüpünün yeri doğrulanır">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Sonda ile beslenen hastalarda besleme ve ilaç vermeden önce enteral beslenme tüpünün yeri doğrulanır</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt17"
                                    value="Sonda ile beslenen hastalarda beslenme süresince ve beslenme sonrası 1 saat yatak başı yükseltilir.">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Sonda ile beslenen hastalarda beslenme süresince ve beslenme sonrası 1 saat yatak başı yükseltilir.</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt18"
                                    value="Yemek yerken ihtiyaç halinde kullanılmak üzere, hasta başında aspirasyon malzemeleri hazır bulundurulur">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Yemek yerken ihtiyaç halinde kullanılmak üzere, hasta başında aspirasyon malzemeleri hazır bulundurulur</span>
                                </label>
                            </div>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_education"
                                    id="nurse_attempt19" value="Bakım verenler besleme ve yutma teknikleri konusunda bilgilendirilir">
                                <label class="form-check-label" for="nurse_education">
                                    <span class="checkbox-header">Bakım verenler besleme ve yutma teknikleri konusunda bilgilendirilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_education"
                                    id="nurse_attempt20" value="Hasta ve bakım verenleri aspirasyon belirti ve bulguları ve aspirasyonu önleyici uygulamalar hakkında bilgi verilir">
                                <label class="form-check-label" for="nurse_education">
                                    <span class="checkbox-header">Hasta ve bakım verenleri aspirasyon belirti ve bulguları ve aspirasyonu önleyici uygulamalar hakkında bilgi verilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_education"
                                    id="nurse_attempt21" value="Bakım verenlerin besleme, aspirasyon, hastaya pozisyon verme gibi uygulamalarının uygunluğu değerlendirilir">
                                <label class="form-check-label" for="nurse_education">
                                    <span class="checkbox-header">Bakım verenlerin besleme, aspirasyon, hastaya pozisyon verme gibi uygulamalarının uygunluğu değerlendirilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_education"
                                    id="nurse_attempt22" value="Bakım verenlere aspirasyon uygulama konusunda eğitim verilir">
                                <label class="form-check-label" for="nurse_education">
                                    <span class="checkbox-header">Bakım verenlere aspirasyon uygulama konusunda eğitim verilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_education"
                                    id="nurse_attempt23" value="Hastanın evde aspire etmesi ihtimaline karşı acil bir plan oluşturma konusunda yardımcı olunur">
                                <label class="form-check-label" for="nurse_education">
                                    <span class="checkbox-header">Hastanın evde aspire etmesi ihtimaline karşı acil bir plan oluşturma konusunda yardımcı olunur</span>
                                </label>
                            </div>
        ...
        $(function(){
            $("#submit").click(function(e){
                ...
                success: function(data) {
                    ...
                    let url =
                        "<?php echo $base_url; ?>/taniReview/tani38-review.php?patient_id=" +
