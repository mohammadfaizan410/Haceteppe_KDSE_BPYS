                ...
                <div class="patients-save">
                    <form action="" method="POST" class="patients-save-fields">
                        ...
                        <div class="input-section d-flex">
                            ...
                            <p class="tanıdescription">Deri bütünlüğünde bozulma</p>
                        </div>
                        <div class="input-section d-flex">
                            <p id="tani_usernamelabel">NOC Çıktıları:</p>
                            <p class="tanıdescription">Hastanın deri ve mukoz membran bütünlüğünün sağlanması</p>
                        </div>
                        ...
                        <div class="input-section" id="o2-delivery-container">
                            ...
                            <div class="form-check">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator" id="noc_indicator" value="1: Hastanın deri ve muköz membranlarında çok şiddetli düzeyde bozulma var">
                                    <label class="form-check-label" for="noc_indicator">
                                        <span class="checkbox-header">1: Hastanın deri ve muköz membranlarında çok şiddetli düzeyde bozulma var</span>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator" id="noc_indicator" value="2: Hastanın deri ve muköz membranlarında şiddetli  düzeyde bozulma var">
                                    <label class="form-check-label" for="noc_indicator">
                                        <span class="checkbox-header">2: Hastanın deri ve muköz membranlarında şiddetli  düzeyde bozulma var</span>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator" id="noc_indicator" value="3: Hastanın deri ve muköz membranlarında orta düzeyde bozulma var">
                                    <label class="form-check-label" for="noc_indicator">
                                        <span class="checkbox-header">3: Hastanın deri ve muköz membranlarında orta düzeyde bozulma var</span>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator" id="noc_indicator" value="4: Hastanın deri ve muköz membranlarında hafif düzeyde bozulma var">
                                    <label class="form-check-label" for="noc_indicator">
                                        <span class="checkbox-header">4: Hastanın deri ve muköz membranlarında hafif düzeyde bozulma var</span>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator" id="noc_indicator" value="5: Hastanın deri ve muköz membranlarında bozulma yok">
                                    <label class="form-check-label" for="noc_indicator">
                                        <span class="checkbox-header">5: Hastanın deri ve muköz membranlarında bozulma yok</span>
                                    </label>
                                </div>
                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <p class="option-error" style="color : red; display : none">Lütfen bir seçenek belirleyin</p>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt" value="Hastanın derisi, deri bütünlüğünde bozulma belirtileri açısından değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Hastanın derisi, deri bütünlüğünde bozulma belirtileri açısından değerlendirilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt" value="Düzenli aralıklarla pozisyon değiştirilir ve yaraya baskı uygulamayacak şekilde pozisyon verilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Düzenli aralıklarla pozisyon değiştirilir ve yaraya baskı uygulamayacak şekilde pozisyon verilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt" value="Periferik venöz katater, santral venöz katater ya da dren bakımı yapılır Yara Bakımı: Her pansuman değişikliğinde yara yeri değerlendirilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Periferik venöz katater, santral venöz katater ya da dren bakımı yapılır Yara Bakımı: Her pansuman değişikliğinde yara yeri değerlendirilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_education" id="nurse_education" value="Hasta ve bakım verenlerine yara yerinde gelişebilecek enfeksiyon belirti ve bulguları öğretilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Hasta ve bakım verenlerine yara yerinde gelişebilecek enfeksiyon belirti ve bulguları öğretilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_education" id="nurse_education" value="Hasta ve bakım verenlerine banyo sırasında insizyonun ıslatılmaması, insizyon geriliminin en aza indirilmesi gibi konularda bilgi verilir">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">Hasta ve bakım verenlerine banyo sırasında insizyonun ıslatılmaması, insizyon geriliminin en aza indirilmesi gibi konularda bilgi verilir</span>
                                </label>
                            </div>
                            <div class="form-check">
                        ...
                        <div class="input-section" id="o2-delivery-container">
                            ...
                            <div class="form-check">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator_after" id="noc_indicator_after" value="1: Hastanın deri ve muköz membranlarında çok şiddetli düzeyde bozulma var">
                                    <label class="form-check-label" for="noc_indicator">
                                        <span class="checkbox-header">1: Hastanın deri ve muköz membranlarında çok şiddetli düzeyde bozulma var</span>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator_after" id="noc_indicator_after" value="2: Hastanın deri ve muköz membranlarında şiddetli  düzeyde bozulma var">
                                    <label class="form-check-label" for="noc_indicator">
                                        <span class="checkbox-header">2: Hastanın deri ve muköz membranlarında şiddetli  düzeyde bozulma var</span>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator_after" id="noc_indicator_after" value="3: Hastanın deri ve muköz membranlarında orta düzeyde bozulma var">
                                    <label class="form-check-label" for="noc_indicator">
                                        <span class="checkbox-header">3: Hastanın deri ve muköz membranlarında orta düzeyde bozulma var</span>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator_after" id="noc_indicator_after" value="4: Hastanın deri ve muköz membranlarında hafif düzeyde bozulma var">
                                    <label class="form-check-label" for="noc_indicator">
                                        <span class="checkbox-header">4: Hastanın deri ve muköz membranlarında hafif düzeyde bozulma var</span>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator_after" id="noc_indicator_after_last" value="5: Hastanın deri ve muköz membranlarında bozulma yok">
                                    <label class="form-check-label" for="noc_indicator">
                                        <span class="checkbox-header">5: Hastanın deri ve muköz membranlarında bozulma yok</span>
                                    </label>
                                </div>
...
let evaluation = 'false';
                ...
                success: function(data) {
                    ...
                    let url =
                        "<?php echo $base_url; ?>/taniReview/tani28-review.php?patient_id=" +
