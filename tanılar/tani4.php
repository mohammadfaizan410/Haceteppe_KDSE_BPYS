                    ...
                    <form action="" method="POST" class="patients-save-fields">
                        ...
                        <div class="input-section" id="o2-delivery-container">
                            ...
                            <div class="form-check">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator2" id="noc_indicator2" value="4: Hastanın idrarı biraz yoğundur">
                                    <label class="form-check-label" for="noc_indicator2">
                        ...
                        <div class="input-section" id="o2-delivery-container">
                            ...
                            <div class="form-check">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator3" id="noc_indicator3" value="1: Hastanın derisi ve ağız mukozası aşırı düzeyde kuru; deri turgoru aşırı zayıflamıştır">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator3" id="noc_indicator3" value="2: Hastanın derisi ve ağız mukozası çok kuru; deri turgoru çok zayıflamıştır">
                                    <label class="form-check-label" for="noc_indicator3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator3" id="noc_indicator3" value="3: Hastanın derisi ve ağız mukozası oldukça kuru; deri turgoru oldukça zayıflamıştır">
                                    <label class="form-check-label" for="noc_indicator3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" required name="noc_indicator3" id="noc_indicator3" value="4: Hastanın derisi ve ağız mukozası biraz kuru; deri turgoru biraz zayıflamıştır">
                                    <label class="form-check-label" for="noc_indicator3">
                        ...
                        <div class="input-section d-flex" style="flex-direction: column;">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt14" value="Hasta ve bakım verenlerine sıvı volüm eksikliği komplikasyonlarının belirtileri öğretilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt15" value="Hasta ve bakım verenlerine aldığı çıkardığı sıvıları nasıl izleyeceği konusunda bilgi verilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt16" value="Hasta ve bakım verenlerine  su içmenin önemi konusunda bilgi verilir">
                                <label class="form-check-label" for="nurse_attempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt17" value="İstem yapılan sıvıların infüzyonu yapılır">
                                <label class="form-check-label" for="nurse_attempt">
                                    <span class="checkbox-header">İstem yapılan sıvıların infüzyonu yapılır</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="nurse_attempt" id="nurse_attempt18" value="İstem yapılan kan ürünlerinin transfüzyonu yapılır">
                                <label class="form-check-label" for="nurse_attempt">
                        ...
                        <div class="input-section d-flex">
                            ...
                            <div class="input-section" id="o2-delivery-container">
                                ...
                                <div class="form-check">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator2_after" id="noc_indicator2_after" value="4: Hastanın idrarı biraz yoğundur">
                                        <label class="form-check-label" for="noc_indicator2_after">
                                            <span class="checkbox-header">4: Hastanın idrarı biraz yoğundur</span>
                                        </label>
                                    </div>
                            ...
                            <div class="input-section" id="o2-delivery-container">
                                ...
                                <div class="form-check">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator3_after" id="noc_indicator3_after" value="1: Hastanın derisi ve ağız mukozası aşırı düzeyde kuru; deri turgoru aşırı zayıflamıştır">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator3_after" id="noc_indicator3_after" value="2: Hastanın derisi ve ağız mukozası çok kuru; deri turgoru çok zayıflamıştır">
                                        <label class="form-check-label" for="noc_indicator3_after">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator3_after" id="noc_indicator3_after" value="3: Hastanın derisi ve ağız mukozası oldukça kuru; deri turgoru oldukça zayıflamıştır">
                                        <label class="form-check-label" for="noc_indicator3_after">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" required name="noc_indicator3_after" id="noc_indicator3_after" value="4: Hastanın derisi ve ağız mukozası biraz kuru; deri turgoru biraz zayıflamıştır">
                                        <label class="form-check-label" for="noc_indicator3_after">
    ...
    <script>
        $(function() {
            $('#submit').click(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $base_url; ?>/insertTanalar/tani4Insert.php',
                    data: {
                        name: name,
                        surname: surname,
                        age: age,
